...
1.  Clone the repository:
    ```bash
    git clone [https://github.com/your-username/tim-and-lobo.git](https://github.com/your-username/tim-and-lobo.git)
    cd tim-and-lobo
    ```
...
2.  Install dependencies:
    ```bash
    npm install
    # Important: Ensure idb-keyval is installed for the new storage engine
...
Over time, thousands of snapshots can slow down the app.
* Go to **Settings** -> **Database Maintenance**.
* Use the **Prune Data** tools to delete snapshots or closed POs older than 1 or 2 years.
